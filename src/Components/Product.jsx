    ...
    return (
        <>
            ...
            <div className="grid grid-cols-3 space-x-2 py-8 px-30">
                <div className="container1 h-[auto] w-[350px]  border-1 border-gray-400  hover:scale-[1.02] transition-transform duration-300 rounded-lg ml-5">
                    ...
                    <div>
                        ...
                        <h1 className="text-teal-600 font-semibold text-sm px-8 pt-6 mb-2 ">Search house prices <ArrowRight className="w-4 h-4 inline ml-2" /></h1>

                    </div>
                </div>
                <div className="container2 h-[auto] w-[350px] border-1 border-gray-400  hover:scale-[1.02] transition-transform duration-300 rounded-lg ml-3">
                    ...
                    <div>
                        ...
                        <h1 className="text-teal-600 font-semibold text-sm px-8 pt-6 mb-4">Take a look <ArrowRight className="w-4 h-4 inline ml-2" /></h1>

                    </div>
                </div>
                <div className="container3  h-[auto] w-[350px] border-1 border-gray-400  hover:scale-[1.02] transition-transform duration-300 rounded-lg">
                    ...
                    <div>
                        ...
                        <h1 className="text-teal-600 text-sm font-semibold px-8 pt-6  mb-4">Take a look <ArrowRight className="w-4 h-4 inline ml-2" /></h1>
