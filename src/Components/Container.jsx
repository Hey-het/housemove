export default function Signcontainer() {
  return (
    <>
      ...
      <div className="mt-8 mx-auto bg-gray-300  p-4 md:p-6 rounded-2xl flex flex-col md:flex-row items-center gap-4 w-[800px] space-x-6">
        ...
        <div className=" items-center justify-center">
          <input
            ...
            className=" border-2 border-white bg-white md:flex-1 px-4 py-3 rounded-lg w-[300px]"
          />
        </div>
      </div>
